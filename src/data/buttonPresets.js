...
const rawButtonPresets = [
  ...
  {
    name: "Solid Primary",
    description: "Clear primary action for everyday product flows.",
    sourceName: "shadcn/ui Button",
    category: "Solid",
    tags: ["solid", "primary", "design-system"],
    config: {
      text: "Save changes",
  ...
  },
  {
    ...
    description: "Primary outline style for lower-emphasis actions.",
    sourceName: "Bootstrap Buttons",
    category: "Outline",
    tags: ["outline", "primary", "bootstrap"],
    config: {
      text: "Learn more",
      size: { borderRadius: 8, height: 40, paddingX: 18 },
      colors: {
  ...
  },
  {
    ...
    description: "Classic Bootstrap-inspired primary button.",
    sourceName: "Bootstrap Buttons",
    category: "Bootstrap",
    tags: ["bootstrap", "primary", "solid"],
    config: {
      text: "Primary",
      size: { borderRadius: 6, height: 38, paddingX: 14 },
      colors: {
        backgroundColor: "#0d6efd",
        textColor: "#ffffff",
        hoverBackgroundColor: "#0b5ed7",
      },
      border: { width: 1, color: "#0d6efd" },
      shadow: { enabled: false },
      effects: { shine: { enabled: false } },
    },
  },
  {
    ...
    description: "Classic Bootstrap-inspired outline button.",
    sourceName: "Bootstrap Buttons",
    category: "Bootstrap",
    tags: ["bootstrap", "outline", "primary"],
    config: {
      text: "Outline",
      size: { borderRadius: 6, height: 38, paddingX: 14 },
      colors: {
